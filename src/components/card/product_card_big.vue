...
<template>
    <div
            ...
            <div class=" h-full w-full  md:w-[max(1200px)] md:px-7 flex flex-col items-center md:items-start">
                ...
                <div
                    ...
                    <span class="opacity-[75%] text-[15px] text-center md:text-start">
                        Experience natural, lifelike audio and exceptional <br class="md:hidden"> build quality made for
                        the passionate music <br class="md:hidden">
                        enthusiast.
                    </span>
                    <router-link :to="{ name: 'product', params: { name: data[3]['slug'] } }" class="flex justify-center items-center">
                        <vbutton />
                    </router-link>
                </div>
            </div>
        ...
        <img class="md:block hidden w-full left-0 right-0 -z-10 relative" src="/assets/home/desktop/image-hero.jpg"
            alt="">
        <img class="md:hidden sm:block hidden  w-full left-0 right-0 -z-10 relative"
            src="/assets/home/tablet/image-header.jpg" alt="">
        <img class="md:hidden sm:hidden w-full left-0 right-0 -z-10 relative" src="/assets/home/mobile/image-header.jpg"
            alt="">
    </div>
</template>
